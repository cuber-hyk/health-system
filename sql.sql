...
CREATE TABLE `food_classification`(food_classification_id int(11) NOT NULL AUTO_INCREMENT COMMENT '食物分类ID',
`food_classification` varchar(64) comment '食物分类',
`recommend` int(11) DEFAULT '0' NOT NULL comment '智能推荐',
`create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
`update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
PRIMARY KEY (food_classification_id))ENGINE=InnoDB DEFAULT CHARSET=utf8 comment '食物分类';
insert into `food_classification` values (1,'食物分类1',0,'2023-02-27 11:01:59','2023-02-27 11:01:59');
insert into `food_classification` values (2,'食物分类2',0,'2023-02-27 11:01:59','2023-02-27 11:01:59');
insert into `food_classification` values (3,'食物分类3',0,'2023-02-27 11:01:59','2023-02-27 11:01:59');
insert into `food_classification` values (4,'食物分类4',0,'2023-02-27 11:01:59','2023-02-27 11:01:59');
insert into `food_classification` values (5,'食物分类5',0,'2023-02-27 11:01:59','2023-02-27 11:01:59');
insert into `food_classification` values (6,'食物分类6',0,'2023-02-27 11:01:59','2023-02-27 11:01:59');
insert into `food_classification` values (7,'食物分类7',0,'2023-02-27 11:01:59','2023-02-27 11:01:59');
insert into `food_classification` values (8,'食物分类8',0,'2023-02-27 11:01:59','2023-02-27 11:01:59');
...
`taboo` varchar(64) comment '食用禁忌',
`energy` varchar(64) comment '能量',
`intended_for` varchar(64) comment '适用人群',
`food_introduction` longtext comment '食物介绍',
