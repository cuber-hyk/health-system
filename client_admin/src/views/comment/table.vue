  ...
  <el-main class="bg table_wrap">
    ...
    >
      ...
      <el-form-item>
        ...
        <!-- <el-form-item>
          <router-link
            v-if="user_group == '管理员' || $check_action('/comment/view')"
            class="el-button float-right el-button&#45;&#45;default el-button&#45;&#45;primary"
            to="./view?"
            >添加
          </router-link>
        </el-form-item> -->
        ...
        <el-button
          v-if="
            user_group == '管理员' || $check_action('/comment/table', 'del')
          "
          ...
          <el-col :xs="24" :sm="24" :lg="24" class="search_btn_1">
            <el-form-item>
              ...
              <el-button
                v-if="
                  user_group == '管理员' ||
                  $check_action('/comment/table', 'del')
                "
                class="search_btn_del"
                type="danger"
                @click="delInfo()"
      ...
      <el-table-column fixed="right" label="操作" width="250">
        <template slot-scope="scope">
          ...
          <a
            ...
            class="el-button el-button--small is-plain el-button--primary"
            v-if="!scope.row['reply_to_id']"
            @click="
              reset();
              query.reply_to_id = scope.row[field];
              search();
            "
          >
            查看被回复
