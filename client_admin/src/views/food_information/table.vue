  ...
  <el-main class="bg table_wrap">
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button>
          <router-link
            v-if="
              user_group == '管理员' ||
              $check_action('/food_information/table', 'add') ||
        ...
        <el-button
          v-if="
            user_group == '管理员' ||
            $check_action('/food_information/table', 'del') ||
            $check_action('/food_information/view', 'del')
          "
      ...
      <!-- <el-row>
        ...
        <el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap_1">
          <el-form-item>
            <el-button type="primary" @click="search()" class="search_btn_find"
              >查询</el-button
            >
    ...
    >
      ...
      <el-table-column
        ...
        @sort-change="$sortChange"
        label="食物名称"
        v-if="user_group == '管理员' || $check_field('get', 'food_name')"
        min-width="200"
        align="center"
      >
      </el-table-column>
      ...
      <el-table-column
        ...
        v-if="
          user_group == '管理员' ||
          $check_action('/food_information/table', 'set') ||
          $check_action('/food_information/view', 'set') ||
          $check_action('/food_information/view', 'get') ||
          $check_action('//table', 'add') ||
          $check_action('//view', 'add')
        "
      >
        <template slot-scope="scope">
          <router-link
          ...
          <router-link
            v-if="
              user_group == '管理员' ||
              $check_comment('/food_information/table')
            "
            class="el-button el-button--small is-plain el-button--primary"
            :to="
              '../comment/table?size=10&page=1&source_table=food_information&source_field=' +
              field +
              '&source_id=' +
              scope.row[field]
            "
...
export default {
  ...
  data() {
    return {
      ...
      // 详情路径
      viewPath: "/food_information/view",
