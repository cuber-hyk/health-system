        ...
        <el-col :xs="24" :sm="10" :lg="8" class="search_btn_wrap_1">
          <el-form-item>
            ...
            <router-link
              v-if="
                user_group == '管理员' ||
                $check_action('/food_classification/table', 'add') ||
                $check_action('/food_classification/view', 'add')
              "
              class="el-button el-button--default el-button--primary search_btn_add"
              to="./view?"
              >添加
    ...
    >
      ...
      <el-table-column
        ...
        v-if="
          user_group == '管理员' ||
          $check_action('/food_classification/table', 'set') ||
          $check_action('/food_classification/view', 'set') ||
          $check_action('/food_classification/view', 'get') ||
