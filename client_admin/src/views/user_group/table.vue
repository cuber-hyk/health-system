  ...
  <el-main class="bg table_wrap">
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          v-if="
            user_group == '管理员' || $check_action('/user_group/table', 'set')
          "
          :disabled="single"
        ...
        <el-button
          v-if="
            user_group == '管理员' || $check_action('/user_group/table', 'del')
          "
        ...
        >
        <router-link
          v-if="user_group == '管理员' || $check_action('/user_group/view')"
          to="./view?"
          ><el-button
