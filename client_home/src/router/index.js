...
const routes = [
		...
		// 食物信息详情路由
	{
		...
		// 食谱信息列表路由
	{
		path: '/recipe_information/list',
		name: '/recipe_information_list',
		component: () => import('../views/recipe_information/list.vue')
	},
	
		// 食谱信息详情路由
	{
		path: '/recipe_information/details',
		name: '/recipe_information_details',
		component: () => import('../views/recipe_information/details.vue')
	},
...
router.afterEach((to, from, next) => {
	let title = "健康饮食推荐系统-home";
	document.title = title;
	document.logo = "健康饮食推荐系统"
})
