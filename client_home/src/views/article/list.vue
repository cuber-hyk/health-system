<template>
    ...
    color: #fff;
    font-size: 22px;">筛选</div>
                                <!-- 筛选 -->
                                <div class="bar_filter">
                                    <button type="button" class="btn btn-secondary" v-for="(o, i) in list_article_type"
                                     :key="i"
                                    @click="filter_article(o)">  {{ o }}</button>
                                </div>
                                <!-- /筛选 -->
                                <div class="bar_filter" style="font-weight: 700;
    color: #fff;
    font-size: 22px;">排序</div>
                                ...
                                >
                                    <button type="button" class="btn btn-secondary" v-for="(o, i) in sort_list"
                                    :key="i" @click="sort_goods(o)">{{ o.name }}</button>
                                </div>
                                <!-- /排序 -->
                            </div>
                            <!-- 文章列表 -->
