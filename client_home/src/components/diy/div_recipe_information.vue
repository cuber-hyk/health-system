<template>
	<div class="diy_details_box diy_div_recipe_information">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/recipe_information/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/recipe_information/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var recipe_information_id = this.obj.recipe_information_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "recipe_information",
          source_field: "recipe_information_id",
          source_id: recipe_information_id
        }, (res) => {
